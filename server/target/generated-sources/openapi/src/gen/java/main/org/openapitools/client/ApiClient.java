...
public class ApiClient {
    ...
    protected String basePath = "https://api.transit-example.com/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.transit-example.com/v1",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.transit-example.com/v1
